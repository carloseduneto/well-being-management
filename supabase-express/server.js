...
//       );
  ...
  axios.get(`${SUPABASE_URL}/rest/v1/treino?select=id,order,exercicio(id,nome,grupos_musculares(nome)),categoria(id,nome, image),series_repeticoes(nome),series_recomendadas(nome,valor)&order=order.asc`, {
